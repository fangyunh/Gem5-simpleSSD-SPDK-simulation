...
PCI_ADDR=${PCI_ADDR:-"0000:02:00.0"}  # PCI Address of the TARGET (Secondary) Drive (Kingston NV2)
CORE_ID=2                 # CPU Core to pin the workload to
CORE_MASK="0x4"           # Hex mask for Core 2
DURATION=30                # Test Duration (Seconds)
OUTPUT_FILE="phase1_results.csv"  # Output Filename
...
mkdir -p "$LOG_DIR"
ERROR_LOG=${ERROR_LOG:-phase1_errors.log}
> "$ERROR_LOG"
